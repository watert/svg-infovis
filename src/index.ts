...
// 运行时判定(260926): `isMainModule` —— bun 专有 `import.meta.main` 的可移植替身。排在最前是因为
// 它谁都不依赖(纯字符串路径比较 + 调用期取 node 内置), 不是因为它比几何层"更底层"; 出口(CLI /
// 模板 / 示例 / 网站管线)都要它, 走 barrel 一处就够 —— 见文件头与 `runtime.ts` 头注释
export * from './runtime.js';
export * from './geometry/vec.js';
export * from './geometry/rounded-path.js';
...
export * from './shapes/inline.js';
export * from './shapes/node.js';
export * from './shapes/edge.js';
...
// 排在解析件之后(被依赖的先出)
export * from './embed/svg-asset.js';
export * from './shapes/embed.js';
// 网格底纹(260920; 同日改名 `grid-pattern` 让位于 `geometry/grid` 的版式格子): 画布装饰层,
// 由 `ExportOptions.grid` 显式开启 —— 不进 scene, 故不参与 audit
export * from './shapes/grid-pattern.js';
export * from './knives/measure.js';
export * from './knives/fit.js';
export * from './knives/route.js';
...
export * from './shapes/stat.js';
export * from './shapes/badge.js';
export * from './shapes/heading.js';
// 成对连线(260920): 单线路由**跑一次**再沿法线平移两条 —— 是 route 的包装, 不是第二个路由器
export * from './knives/route-pair.js';
...
export * from './knives/route-cost.js';
...
export * from './knives/describe.js';
